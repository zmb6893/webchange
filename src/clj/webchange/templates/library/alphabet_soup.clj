(ns webchange.templates.library.alphabet-soup
    (:require
...
(def m {:id          17
        ...
        :description "Making Alphabet Soup"
...
(def t {:assets        [{:url "/images/dashboard/scene-preview/Kitchen_Background.jpg", :size 10, :type "image"}
        ...
        :objects       {:background {:type "background", :src "/images/dashboard/scene-preview/Kitchen_Background.jpg"}
                        :soup       {:type "image", :src "/images/soup-game-elements/bowl.jpg"}
                        :tablet     {:type "image", :src "/images/soup-game-elements/tablet.jpg"}
                        :blank      {:type "image", :src "/images/soup-game-elements/blank-square.jpg"}}
        :scene-objects [["background"] ["tablet" "soup"]],
